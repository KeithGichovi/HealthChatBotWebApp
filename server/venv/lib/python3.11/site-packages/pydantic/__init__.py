...
__all__ = (
    ...
    # root_model
    'RootModel',
    # deprecated tool_functions, these are imported via `__getattr__` below
    'parse_obj_as',
    'schema_of',
    'schema_json_of',
    # types
...
_dynamic_imports: 'dict[str, tuple[str, str]]' = {
    ...
    'parse_obj_as': (__package__, '.deprecated.tool_functions'),
    'schema_of': (__package__, '.deprecated.tool_functions'),
    'schema_json_of': (__package__, '.deprecated.tool_functions'),
