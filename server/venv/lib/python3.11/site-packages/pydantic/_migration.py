...
DEPRECATED_MOVED_IN_V2 = {
    'pydantic.tool_functions:schema_of': 'pydantic.deprecated.tool_functions:schema_of',
    'pydantic.tool_functions:parse_obj_as': 'pydantic.deprecated.tool_functions:parse_obj_as',
    'pydantic.tool_functions:schema_json_of': 'pydantic.deprecated.tool_functions:schema_json_of',
...
REMOVED_IN_V2 = {
    ...
    'pydantic:stricturl',
    'pydantic.tool_functions:parse_file_as',
    'pydantic.tool_functions:parse_raw_as',
