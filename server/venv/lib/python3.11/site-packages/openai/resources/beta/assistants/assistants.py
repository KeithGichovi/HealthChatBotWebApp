    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          tools: A list of tool enabled on the assistant. There can be a maximum of 128 tool_functions per
    ...
    def update(
        ...
        *,
        ...
        The maximum length is 512 characters.
          ...
          tool_functions: A list of tool enabled on the assistant. There can be a maximum of 128 tool_functions per
              assistant. Tools can be of types `code_interpreter`, `retrieval`, or `function`.
