...
class Runs(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          tools: Override the tool_functions the assistant can use for this run. This is useful for
    ...
    def submit_tool_outputs(
        ...
        *,
        ...
        Args:
          tool_outputs: A list of tool_functions for which the outputs are being submitted.
