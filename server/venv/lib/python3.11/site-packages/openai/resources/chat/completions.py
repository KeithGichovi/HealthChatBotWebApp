        ...
        *,
        ...
        Args:
          ...
          model: ID of the model to use. See the
              ...
              table for details on which models work with the ChatSection API.
          ...
          functions: Deprecated in favor of `tool_functions`.
          ...
          tools: A list of tool_functions the model may call. Currently, only functions are supported as a
