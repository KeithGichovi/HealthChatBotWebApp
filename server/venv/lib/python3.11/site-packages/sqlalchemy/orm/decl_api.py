...
class _declared_attr_common:
    def __init__(
        ...
        #    ...
        # which seems to help typing tool_functions interpret the fn as a classmethod
...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    ...
    to :pep:`484` typing tool_functions that the given method is not dealing with
    ...
    typing tool_functions that don't otherwise recognize the decorated function as
...
def declarative_base(
    *,
    ...
    .. versionchanged:: 2.0 Note that the :func:`_orm.declarative_base`
       ...
       with :pep:`484` typing tool_functions.
